...
def get_conversational_chain():
    ...
    all the details. If the answer is not available in the provided context, jus say. "Answer is not available
...
def main():
    st.set_page_config("Interact with multiple PDFs")
    st.header("AlphaNimble: Use Gemini to talk to PDFs")

    user_question = st.text_input("Ask a question on the PDF files")
